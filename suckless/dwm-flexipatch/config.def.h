...
static const Key keys[] = {
	...
	{ 0, XF86XK_AudioRaiseVolume, spawn, SHCMD("pamixer -i 5; kill -44 $(pidof slstatus)") },
	{ 0, XF86XK_AudioLowerVolume, spawn, SHCMD("pamixer -d 5; kill -44 $(pidof slstatus)") },
	{ 0, XF86XK_AudioMute,        spawn, SHCMD("pamixer -t; kill -44 $(pidof slstatus)") },
